...
hyperparameters_embedder = JoinedAutoencoderHyperparametersEmbedder(
    ckpt_path="/Users/cherniak/itmo_job/GAMLET/experiment_logs/embed_hyperparameters/to_4_with_learnables/checkpoints/epoch=9-step=980.ckpt",
    embedding_dim=4,
    with_learnable=True,
)
...
dataset_directory="/Users/cherniak/itmo_job/GAMLET/data/no_meta_features_and_fedot_pipelines__no_type_with_hyperparams(4_with_learnables)"
