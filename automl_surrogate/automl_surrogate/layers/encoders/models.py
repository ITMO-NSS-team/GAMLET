...
class GraphTransformer(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        encoder_layer = TransformerEncoderLayer(
            d_model, num_heads, dim_feedforward, dropout, batch_norm=batch_norm, gnn_type=gnn_type, se=se, **kwargs
        )
    ...
    def forward(self, data: Batch, return_attn: bool = False) -> Tensor:
