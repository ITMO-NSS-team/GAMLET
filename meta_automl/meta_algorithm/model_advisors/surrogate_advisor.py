...
class SurrogateGNNPipelineAdvisor(ModelAdvisor):
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        features_preprocessor = FeaturesPreprocessor(load_path=config["pipelines_data"]["root_path"]+"meta_features_preprocessors.pickle")
    ...
    def predict(self, dataset: pd.DataFrame, k: int = 5) -> List[List[Model]]:
        ...
        # нужно переписать, когда будет работающий FeaturesExtractor, который будет принимать DataFrame, а не dataset_id !!!!
