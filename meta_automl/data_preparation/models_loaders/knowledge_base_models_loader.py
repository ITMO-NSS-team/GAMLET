...
class KnowledgeBaseModelsLoader(ModelsLoader):
    ...
    def load(self, dataset_ids: Optional[Sequence[str]] = None,
        ...
        # self.df_knowledge_base['fitness_coef'] = (self.df_knowledge_base['fitness_metric']=="logloss") | (self.df_knowledge_base['fitness_metric']=="fitness") 
        # self.df_knowledge_base['fitness_coef'] = -2*self.df_knowledge_base['fitness_coef'].astype(int)+1
